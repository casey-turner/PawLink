                    ...
                    <ul>
                        ...
                        <?php
                            if (isset($_SESSION['userstate']) && ($_SESSION['userstate'] == 'member')) {  ?>
                                <li><a href="?controller=users&action=logout" class="orange-btn hp-login-btn">Log out</a></li>
                        <?php } else { ?>
                ...
                <div class="container">
                    <nav class="dashboard-nav">
                        <ul>
                            ...
                            <li><a href="?controller=profiles&action=profile">Profile</a></li>
                            <li><a href="?controller=profiles&action=feedback">Feedback</a></li>
